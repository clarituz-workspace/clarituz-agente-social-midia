...
| Asset Text | `SM_Config` | `{"ig_user_id":"","fb_page_id":"","llm_model":"gpt-4o","calendario_editorial":{},"termos_proibidos":[],"janelas_sugeridas":"09:00-12:00;18:00-21:00","limite_posts_dia":3,"dias_calendario":7,"gerar_imagem":false,"imagem_modelo":"gpt-image-1","imagem_tamanho":"1024x1024","imagem_qualidade":"high"}` |
...
- Pacote **1.0.6** publicado; processo `clarituz-agente-social-midia` na pasta `Shared` (release `729fd7ab-7ecf-46cb-a90a-1a67c3467748`)
