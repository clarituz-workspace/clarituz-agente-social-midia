...
**Versão testada:** 1.1.1 (publicada e ativa no Orchestrator, pasta Shared)
...
**Suíte automatizada: 35/35 assertions — 100% de acerto** ✅
...
| T_PARSE — Parsers LLM + calendário + aprendizado + A/B | 12 | 12 | 100% |
